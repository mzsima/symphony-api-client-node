...
SymBotAuth.sessionAuthenticate = (symConfig) => {
  ...
  if (symConfig.authType == 'rsa') {
    ...
    options = {
      ...
      "method": "POST",
      "key": symConfig.botCert || fs.readFileSync(symConfig.botCertPath + symConfig.botCertName, 'utf8'),
      "cert": symConfig.botCert || fs.readFileSync(symConfig.botCertPath + symConfig.botCertName, 'utf8'),
